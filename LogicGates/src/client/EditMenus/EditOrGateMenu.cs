...
{
    public class EditOrGateMenu : EditComponentMenu, IAssignMyFields
    {
        [AssignMe]
        public InputSlider InputCountSlider;

        [Setting_Secret("FoxFireFive.LogicGates.Secret.MaxPegsAllowed_OrGate")]
        private static int MaxPegs { get; set; } = 4;

        public static void Setup()
        {
            WS.window("FoxFireFive.LogicGates.OrGate")
            .setYPosition(150)
        ...
        {
            yield return "FoxFireFive.LogicGates.OrGate";
        }
    }
}